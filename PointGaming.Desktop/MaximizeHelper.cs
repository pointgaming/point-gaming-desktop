...
namespace PointGaming.Desktop
{
    ...
    {
        public static void Help(Window window)
        {
            MyHelper helper = new MyHelper { Window = window };
            window.SourceInitialized += helper.SourceInitialized;
            if (window.IsInitialized)
                helper.SourceInitialized(null, null);
        }
